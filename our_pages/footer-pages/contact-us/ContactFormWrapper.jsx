...
const ContactFormWrapper = ({ active, setActive }) => {
  ...
  const s = useTranslations("contactUs.bannerSuggestion");
  const [copiedEmail, setCopiedEmail] = useState(null);
  const [copiedComplaintEmail, setCopiedComplaintEmail] = useState(null);
  ...
  const handleCopyComplaintEmail = () => {
    navigator.clipboard.writeText("support@primexcapital.com");
    setCopiedComplaintEmail(true);
    setTimeout(() => setCopiedComplaintEmail(false), 2000);
  };
                ...
                <div
                  className={`${
                    copiedComplaintEmail
                      ? "bg-gb dark:bg-gb-dark border-2 border-gc dark:border-gc-dark"
                      : "bg-cc dark:bg-cc-dark border-2 border-cc dark:border-cc-dark hover:border-e1 dark:hover:border-e1-dark"
                  } text-tm dark:text-tm-dark py-2 px-4 flex items-center rounded-lg group transition-all duration-500 ease-in-out`}
                >
                  <span
                    className={`${
                      locale === "ar" ||
                  ...
                  {s("copy_email")}
                  <div
                    onClick={handleCopyComplaintEmail}
