...
const CashbackReward = () => {
  ...
  const t = useTranslations("cashback.cashbackReward");
  return (
          ...
          <div className="col-span-12 md:col-span-6 hidden md:block">
            <div className="">
              <Image
                ...
                src={
                  theme === "dark"
                    ? "https://primexcapital.s3.eu-north-1.amazonaws.com/website/cashback/Unlimited+Cashback+Reward.png"
                    : "https://primexcapital.s3.eu-north-1.amazonaws.com/website/cashback/light/Unlimited+Cashback+Reward.png"
                }
                width="100"
                height="100"
                alt="Cashback Reward"
