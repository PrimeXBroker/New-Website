...
const AccountTypesPricingTableMobile = () => {
  ...
  const tabContent = {
    cent: {
      id: 1,
      deposit: t("cent.deposit"),
      spread: t("cent.spread"),
      commissions: t("cent.commissions"),
      leverage: t("cent.leverage"),
      marginRequired: t("cent.marginRequired"),
      minimumLotSize: t("cent.minimumLotSize"),
      stopOutLevel: t("cent.stopOutLevel"),
      marginCallLevel: t("cent.marginCallLevel"),
      executionType: t("cent.executionType"),
      vps: t("cent.vps"),
      metaTrader5: t("cent.metaTrader5"),
      automaticTrading: t("cent.automaticTrading"),
      demoAccount: t("cent.demoAccount"),
      webinars: t("cent.webinars"),
      expertAdvice: t("cent.expertAdvice"),
      swap: t("swapFreeNote"),
      btnTxt: t("cent.btnTxt"),
    },
    standard: {
      id: 2,
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-2 text-tm dark:text-tm-dark">
          ...
          <div className="text-center text-ts dark:text-ts-dark text-sm sm:text-base bg-cc dark:bg-cc-dark px-5 py-6">
            <div
              className={`${
                `${tabContent[activeTab].automaticTrading}` === "X"
