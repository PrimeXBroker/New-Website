...
const OpenAccount = () => {
  ...
  const t = useTranslations("hammurabiAccount.openLiveAccount");
  ...
  return (
    <section className="bg-p dark:bg-p-dark py-16 sm:py-28">
      <div className="container mx-auto px-4">
        ...
        >
          <div>
            <p className="text-base font-semibold text-center md:text-start max-w-lg mb-2 text-pcp dark:text-pcp-dark">
              {t("subtitle")}
            </p>
            <p className="text-lg sm:text-2xl font-semibold text-center md:text-start max-w-lg">
              {t("title")}
            </p>
          </div>
          <CustomYellowButton
