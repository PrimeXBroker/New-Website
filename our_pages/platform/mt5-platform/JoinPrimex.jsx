    ...
    <section className="container flex flex-col md:flex-row justify-center items-center py-12">
      <div>
        ...
        <div className=" pt-5 flex flex-row md:gap-6 flex-wrap justify-center lg:justify-start ">
          <a href="https://download.mql5.com/cdn/web/22640/mt5/primexbroker5setup.exe" target="_blank" className="relative  mb-2">
            ...
            {/* <div className="bg-primary w-12 h-12 absolute left-[-10px] rounded-3xl" > <div className=" h-[100%] flex items-center justify-center text-[#01a6f0]"><FaWindows /></div>  </div> */}
          ...
          <a href="https://download.mql5.com/cdn/mobile/mt5/android?server=PrimeXBroker-Demo,PrimeXBroker-Live" target="_blank" className="relative mb-2">
            ...
            <button className="border-2 border-secondary rounded-full border-opacity-75 text-[13px] font-semibold text-secondary px-2 py-3 pl-10" >Download For Android</button>
          </a>
          <a href="https://download.mql5.com/cdn/mobile/mt5/ios?server=PrimeXBroker-Live" target="_blank"  className="relative ">
            <img src="https://primexcapital.s3.eu-north-1.amazonaws.com/website/platform/mt5/icon-09.svg" className="w-12 absolute left-[-10px]" />
            <button className="border-2 border-secondary rounded-full border-opacity-75 text-[13px] font-semibold text-secondary px-2 py-3 pl-10" >Download For IOS</button>
          </a>
        </div>
      </div>
      <div>
