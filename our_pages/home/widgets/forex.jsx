...
export default function Forex() {
    useEffect(() => {
        const container = document.getElementById('tradingview-widget-container-forex');
        if (container) {
    ...
    return (
        <div id="tradingview-widget-container-forex" className="tradingview-widget-container-forex">
