  ...
  const iconicFeatures = [
    {
      ...
      icon: "https://primexcapital.s3.eu-north-1.amazonaws.com/website/primex-bonus/page-images/Trusted-Global-Broker.svg",
    },
    {
      title1: t("home_feature_2_title1"),
      title2: t("home_feature_2_title2"),
      description: t("home_feature_2_description"),
      icon: "https://primexcapital.s3.eu-north-1.amazonaws.com/website/primex-bonus/page-images/Lightning-Fast-Trade-Execution.svg",
    },
    {
      title1: t("home_feature_3_title1"),
      title2: t("home_feature_3_title2"),
      description: t("home_feature_3_description"),
      icon: "https://primexcapital.s3.eu-north-1.amazonaws.com/website/primex-bonus/page-images/Trailblazing-technology.svg",
    },
    {
      title1: t("home_feature_4_title1"),
      title2: t("home_feature_4_title2"),
      description: t("home_feature_4_description"),
      icon: "https://primexcapital.s3.eu-north-1.amazonaws.com/website/primex-bonus/page-images/7-Dedicated-Multilingual-Support.svg",
    },
    {
      title1: t("home_feature_5_title1"),
      title2: t("home_feature_5_title2"),
      description: t("home_feature_5_description"),
      icon: "https://primexcapital.s3.eu-north-1.amazonaws.com/website/primex-bonus/page-images/Lucrative-Partnership-Programs.svg",
    },
    {
      title1: t("home_feature_6_title1"),
      title2: t("home_feature_6_title2"),
      description: t("home_feature_6_description"),
      icon: "https://primexcapital.s3.eu-north-1.amazonaws.com/website/primex-bonus/page-images/Security-of-Funds.svg",
    },
    {
      title1: t("home_feature_7_title1"),
      title2: t("home_feature_7_title2"),
      description: t("home_feature_7_description"),
      icon: "https://primexcapital.s3.eu-north-1.amazonaws.com/website/primex-bonus/page-images/Multi-Asset-Portfolio.svg",
    },
    {
      title1: t("home_feature_8_title1"),
      title2: t("home_feature_8_title2"),
      description: t("home_feature_8_description"),
      icon: "https://primexcapital.s3.eu-north-1.amazonaws.com/website/primex-bonus/page-images/Withdrawal.svg",
    },
  ];
