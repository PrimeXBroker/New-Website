...
const PrizesBreakdown = () => {
  const t = useTranslations("newBonusPage.bonusPrizeBreakdown");
  ...
  const cards = [
    ...
    },
    {
      title: t("step2"),
      imageSrc:
        "https://primexcapital.s3.eu-north-1.amazonaws.com/website/primex-bonus/open-account-new.png",
    ...
    },
    {
      title: t("step4"),
      imageSrc:
        "https://primexcapital.s3.eu-north-1.amazonaws.com/website/primex-bonus/receive-bonus-new.png",
