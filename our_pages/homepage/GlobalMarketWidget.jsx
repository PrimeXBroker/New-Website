...
const GlobalMarketWidget = () => {
  ...
  return (
    <section className="py-16 sm:py-28 relative bg-p dark:bg-p-dark">
      <div className="container grid grid-cols-1 lg:grid-cols-2 items-center">
        ...
        >
          <h2 className="text-3xl md:text-3xl lg:text-7xl xl:text-8xl mb-2 text-[#ffffff] font-semibold">
        ...
        >
          <h2 className=" text-3xl md:text-4xl lg:text-7xl xl:text-8xl mb-8 text-tm dark:text-tm-dark font-semibold">
            {t("title1")} <br className="hidden lg:block" />
          ...
          <p className="text-lg text-ts dark:text-ts-dark">{t("desc")}</p>
        </div>
      </div>
    </section>
  );
...
export default GlobalMarketWidget;
