...
export default function PsSitemapPage() {
  const urls = [
    { url: "https://primexcapital.com/ps", lastModified: new Date() },
    { url: "https://primexcapital.com/ps/app", lastModified: new Date() },
    {
      url: "https://primexcapital.com/ps/platform/mt5-platform",
      lastModified: new Date(),
    },
    { url: "https://primexcapital.com/ps/forex", lastModified: new Date() },
    { url: "https://primexcapital.com/ps/metals", lastModified: new Date() },
    { url: "https://primexcapital.com/ps/indices", lastModified: new Date() },
    {
      url: "https://primexcapital.com/ps/commodities",
      lastModified: new Date(),
    },
    { url: "https://primexcapital.com/ps/stocks", lastModified: new Date() },
    { url: "https://primexcapital.com/ps/crypto", lastModified: new Date() },
    {
    ...
    { url: "https://primexcapital.com/ps/about", lastModified: new Date() },
    { url: "https://primexcapital.com/ps/contact", lastModified: new Date() },
    { url: "https://primexcapital.com/ps/awards", lastModified: new Date() },
    {
      url: "https://primexcapital.com/ps/client-agreement",
      lastModified: new Date(),
    },
    { url: "https://primexcapital.com/ps/terms", lastModified: new Date() },
