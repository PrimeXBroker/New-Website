export async function GET() {
  const urls = [
    ...
    {
      url: "https://primexcapital.com/ps/fx-cfds",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    ...
    {
      url: "https://primexcapital.com/ps/cashback",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/ps/careers",
      lastModified: new Date(),
      priority: 0.7,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/ps/privacy-policy",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/ps/app-privacy-policy",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/ps/funded-account",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/ps/forex-in-three-steps",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/ps/grey-label-partnership-page",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/ps/investment-fund-agreement",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/ps/traders-initiative",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
