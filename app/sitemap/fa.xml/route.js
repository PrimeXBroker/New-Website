export async function GET() {
  const urls = [
    ...
    {
      url: "https://primexcapital.com/fa/economic-calendar",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    ...
    {
      url: "https://primexcapital.com/fa/investment-fund-agreement",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/fa/traders-initiative",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
