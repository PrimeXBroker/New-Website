...
export default function EsSitemapPage() {
  const urls = [
    ...
    {
      url: "https://primexcapital.com/es/fx-cfds",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    ...
    {
      url: "https://primexcapital.com/es/cashback",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/es/careers",
      lastModified: new Date(),
      priority: 0.7,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/es/privacy-policy",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/es/app-privacy-policy",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/es/funded-account",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/es/forex-in-three-steps",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/es/grey-label-partnership-page",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/es/investment-fund-agreement",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
    {
      url: "https://primexcapital.com/es/traders-initiative",
      lastModified: new Date(),
      priority: 0.8,
      changefreq: "daily",
    },
