import LiquidityWrapper from "@/our_pages/liquidity/LiquidityWrapper";
...
export async function generateMetadata({ params: { locale } }) {
  ...
  const url =
    locale != "en"
      ? `${process.env.NEXT_PUBLIC_BASE_URL}/${locale}/liquidity`
      : `${process.env.NEXT_PUBLIC_BASE_URL}/liquidity`;
