      ...
      <div className="container mx-auto">
        <div className="bg-cc dark:bg-cc-dark text-tm dark:text-tm-dark p-8 rounded-[20px] w-full flex flex-col gap-y-6 relative shadow-lg">
          <div className="flex items-center justify-between">
            ...
            >
              <Image
                src={
                  theme === "dark"
                    ? "https://primexcapital.s3.eu-north-1.amazonaws.com/website/footer-pages/policy/Client+Agreement.svg"
                    : "https://primexcapital.s3.eu-north-1.amazonaws.com/website/light-mode-icons/policy/Client+Agreement.svg"
                }
                alt="Client Agreement"
                width="34"
                height="200"
              />
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-x-4">
            <a
              href="https://primexcapital.s3.eu-north-1.amazonaws.com/website/assets/PDF/footer-agreements/PrimeX_Capital_Client_Agreement.pdf"
              target="_blank"
