...
const Banner = () => {
  ...
  const t = useTranslations("footer.riskDisclosure");
      ...
      <div className="container mx-auto">
        <div className="bg-cc dark:bg-cc-dark text-tm dark:text-tm-dark p-8 rounded-[20px] w-full flex flex-col gap-y-6 relative shadow-lg">
          <div className="flex items-center justify-between">
            ...
            >
              <Image
                src={
                  theme === "dark"
                    ? "https://primexcapital.s3.eu-north-1.amazonaws.com/website/footer-pages/policy/Risk+Disclosure.svg"
                    : "https://primexcapital.s3.eu-north-1.amazonaws.com/website/light-mode-icons/policy/Risk+Disclosure.svg"
                }
                alt="Risk Disclosure"
                width="34"
                height="200"
          ...
          <div className="flex flex-col sm:flex-row gap-x-4">
            <a
              href="https://primexcapital.s3.eu-north-1.amazonaws.com/website/assets/PDF/footer-agreements/PrimeX_Capital_Risk_Acknowledgement_and_Disclosure.pdf"
              target="_blank"
            ...
            <a
              onClick={() =>
                handleDownload(
                  "/assets/pdf/PrimeX_Capital_Risk_Acknowledgement_and_Disclosure.pdf",
                  "PrimeX Capital Risk Acknowledgement and Disclosure"
                )
              }
