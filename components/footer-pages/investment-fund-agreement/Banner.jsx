...
import investmentFundAgreement from "@/public/animations/policies/investment-fund.json";
import Lottie from "lottie-react";

const Banner = () => {
  const locale = useLocale();
  const t = useTranslations("footer.investmentFundAgreement");
      ...
      <div className="container mx-auto">
        <div className="bg-cc dark:bg-cc-dark text-tm dark:text-tm-dark p-8 rounded-[20px] w-full flex flex-col gap-y-6 relative shadow-lg">
          <div className="flex items-center justify-between">
            ...
            >
              <Lottie
                animationData={investmentFundAgreement}
                loop={true}
          ...
          <div className="flex flex-col sm:flex-row gap-x-4">
            <a
              href="https://primexcapital.s3.eu-north-1.amazonaws.com/website/PDF/PrimeX_Capital_Investment_Fund_Agreement.pdf"
              target="_blank"
            ...
            <a
              onClick={() =>
                handleDownload(
                  "/assets/pdf/PrimeX_Capital_Investment_Fund_Agreement.pdf",
                  "PrimeX Capital Investment Fund Agreement",
                )
              }
