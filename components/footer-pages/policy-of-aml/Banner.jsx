      ...
      <div className="container mx-auto">
        <div className="bg-[#111111] text-[#ffffff] border-[#1d1d1d] border-2 p-8 rounded-[20px] w-full flex flex-col gap-y-6 relative shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-x-4">
            <a
              href="https://primexcapital.s3.eu-north-1.amazonaws.com/website/assets/PDF/primex-footer-legal/PrimeX_Capital_Policy_of_AML.pdf"
              target="_blank"
            ...
            <a
              onClick={() =>
                handleDownload(
                  "/assets/pdf/PrimeX_Capital_Policy_of_AML.pdf",
                  "PrimeX Capital Policy of AML"
                )
              }
