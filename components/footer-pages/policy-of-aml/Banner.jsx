...
const Banner = () => {
  ...
  const t = useTranslations("footer.amlPolicy");
  return (
    <section className={`bg-secondary  md:h-screen pt-[60px] lg:pt-18`}>
      <div className="container flex flex-col md:flex-row justify-evenly gap-10 items-center py-12">
        ...
        <div>
          <Image
            src="https://primexcapital.s3.eu-north-1.amazonaws.com/website/footer-pages/risk/aml-rule.webp"
            width="300"
            height="300"
            alt="banner Image"
          />
      ...
      <div className="container py-8 flex flex-col md:flex-row items-center justify-center gap-10">
        <Button
          title="Click to View"
          as="a"
          href="https://primexcapital.s3.eu-north-1.amazonaws.com/website/assets/PDF/footer-legal/PrimeX_Capital_Policy_of_AML.pdf"
          color="white"
