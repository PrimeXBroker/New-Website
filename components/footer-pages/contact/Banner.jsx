...
const ContactBanner = () => {
  ...
  return (
    <section
      className={`bg-secondary bg-[url("https://primexcapital.s3.eu-north-1.amazonaws.com/website/contact-us/Main-Banner-Background.webp")] md:h-[373px] h-auto  bg-no-repeat bg-cover`}
    >
