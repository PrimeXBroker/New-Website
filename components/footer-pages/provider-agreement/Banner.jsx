...
const Banner = () => {
  ...
  const t = useTranslations("footer.providerAgreement");
      ...
      <div className="container mx-auto">
        <div className="bg-cc dark:bg-cc-dark text-tm dark:text-tm-dark p-8 rounded-[20px] w-full flex flex-col gap-y-6 relative shadow-lg">
          <div className="flex items-center justify-between">
            ...
            >
              <Image
                src={
                  theme === "dark"
                    ? "https://primexcapital.s3.eu-north-1.amazonaws.com/website/footer-pages/provider-icon.svg"
                    : "https://primexcapital.s3.eu-north-1.amazonaws.com/website/light-mode-icons/policy/provider-icon.svg"
                }
                alt="Provider Agreement Social Trading Program"
                width="34"
                height="200"
              />
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-x-4">
            <a
              href="https://primexcapital.s3.eu-north-1.amazonaws.com/website/assets/PDF/footer-agreements/Provider_Agreement_Social_Trading_Program.pdf"
              target="_blank"
            ...
            <a
              onClick={() =>
                handleDownload(
                  "/assets/pdf/Provider_Agreement_Social_Trading_Program.pdf",
                  "PrimeX Capital Provider Agreement Social Trading Program"
                )
              }
