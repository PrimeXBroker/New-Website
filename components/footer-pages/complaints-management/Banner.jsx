      ...
      <div className="container mx-auto">
        <div className="bg-cc dark:bg-cc-dark text-tm dark:text-tm-dark p-8 rounded-[20px] w-full flex flex-col gap-y-6 relative shadow-lg">
          <div className="flex items-center justify-between">
            ...
            >
              <Image
                src={
                  theme === "dark"
                    ? "https://primexcapital.s3.eu-north-1.amazonaws.com/website/footer-pages/policy/Complaints+Management.svg"
                    : "https://primexcapital.s3.eu-north-1.amazonaws.com/website/light-mode-icons/policy/Complaints+Management.svg"
                }
          ...
          <div className="flex flex-col sm:flex-row gap-x-4">
            <a
              href="https://primexcapital.s3.eu-north-1.amazonaws.com/website/assets/PDF/footer-agreements/PrimeX_Capital_Complaints_Management_Policy.pdf"
              target="_blank"
            ...
            <a
              onClick={() =>
                handleDownload(
                  "/assets/pdf/PrimeX_Capital_Complaints_Management_Policy.pdf",
                  "PrimeX Capital Complaints Management Policy"
                )
              }
