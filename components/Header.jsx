  ...
  return (
    ...
    >
      ...
      <NavbarContent justify="end">
        <NavbarItem>
          <Link href="#">
            <button className="group rounded-full relative min-h-[40px] w-32 overflow-hidden border border-[#3F3F3E] bg-white text-[#FFD000] shadow-2xl transition-all before:absolute before:left-0 before:top-0 before:h-0 before:w-1/4 before:bg-[#FFD000] before:duration-500 after:absolute after:bottom-0 after:right-0 after:h-0 after:w-1/4 after:bg-[#FFD000] after:duration-500 hover:text-white hover:before:h-full hover:after:h-full">
