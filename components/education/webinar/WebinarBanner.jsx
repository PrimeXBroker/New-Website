...
const WebinarBanner = () => {
  ...
  return (
    <section className="relative lg:h-[92vh] h-screen">
      <div
        className={`container h-screen flex flex-col pt-10 z-10 ${
          locale === "ar" ? "lg:pt-[15rem]" : "lg:pt-[15rem]"
        }`}
      >
        <h1
          className={`text-primary z-10 text-2xl md:text-[36px] lg:text-[52px] font-semibold mb-5  text-center lg:text-left ${
            locale === "ar"
        ...
        >
          {t("desc1_1")} <br className="hidden sm:block" />
          {t("desc1_2")}
        </p>
      </div>
      <div className="lg:hidden absolute inset-0 w-full h-full bg-opacity-100 z-0">
        <Image
          src="https://primexcapital.s3.eu-north-1.amazonaws.com/website/education/webinar/mob_bg_eng.webp"
      ...
      <div className="hidden lg:block absolute inset-0 w-full h-full bg-opacity-100 z-0">
        <Image
          src={
            locale === "ar"
              ? "https://primexcapital.s3.eu-north-1.amazonaws.com/website/education/webinar/main_banner_ar.webp"
